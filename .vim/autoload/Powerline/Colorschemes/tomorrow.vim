...
let g:Powerline#Colorschemes#tomorrow#colorscheme = Pl#Colorscheme#Init([
	...
	\ Pl#Hi#Segments(['fileinfo.flags'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['current_function', 'fileformat', 'fileencoding', 'pwd', 'rvm:string', 'rvm:statusline', 'virtualenv:statusline', 'charcode', 'currhigroup'], {
		\ 'n': ['gray7', 'gray10'],
